...
export const COMMAND_SPECS: CommandSpec[] = [
  ...
  { key: "system restore-backup", usage: "system restore-backup --backup-dir <dir-eller-.tar> --target-company <path> [--verify-key <path>] [--public-key <path>]", description: "Gendanner en backup til en ny virksomhedssti. --backup-dir kan pege på enten en backup-mappe eller et .tar-arkiv (kræver typisk --verify-key for et arkiv).", allowedFlags: ["--backup-dir", "--target-company", "--verify-key", "--public-key"] },
